...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        <a target="_blank" rel="noopener noreferrer" href="/trekhleb/machine-learning-experiments/blob/master/demos/src/images/digits_recognition_cnn.png"><img src="/trekhleb/machine-learning-experiments/raw/master/demos/src/images/digits_recognition_cnn.png" alt="手写数字识别（CNN）" style="max-width: 100%;"></a>
      </td>
      <td>
        <a href="/trekhleb/machine-learning-experiments/blob/master/experiments/digits_recognition_cnn/digits_recognition_cnn.ipynb">
          <b><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">手写数字识别（CNN）</font></font></b>
        </a>
      </td>
      <td>
    ...
    <tr>
      <td>
        <a target="_blank" rel="noopener noreferrer" href="/trekhleb/machine-learning-experiments/blob/master/demos/src/images/sketch_recognition_cnn.png"><img src="/trekhleb/machine-learning-experiments/raw/master/demos/src/images/sketch_recognition_cnn.png" alt="手写草图识别（CNN）" width="150" style="max-width: 100%;"></a>
      </td>
      <td>
        <a href="/trekhleb/machine-learning-experiments/blob/master/experiments/sketch_recognition_cnn/sketch_recognition_cnn.ipynb">
          <b><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">手写草图识别（CNN）</font></font></b>
        </a>
      </td>
      <td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <a href="/trekhleb/machine-learning-experiments/blob/master/experiments/text_generation_shakespeare_rnn/text_generation_shakespeare_rnn.ipynb">
          <b><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">莎士比亚文本生成 (RNN)</font></font></b>
        </a>
      </td>
      <td>
      ...
      <td>
        <a href="https://storage.googleapis.com/download.tensorflow.org/data/shakespeare.txt" rel="nofollow"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
          莎士比亚
        </font></font></a>
      </td>
    </tr>
    ...
    <tr>
      <td>
        <a target="_blank" rel="noopener noreferrer" href="/trekhleb/machine-learning-experiments/blob/master/demos/src/images/text_generation_wikipedia_rnn.png"><img src="/trekhleb/machine-learning-experiments/raw/master/demos/src/images/text_generation_wikipedia_rnn.png" alt="维基百科文本生成（RNN）" width="150" style="max-width: 100%;"></a>
      </td>
      <td>
        <a href="/trekhleb/machine-learning-experiments/blob/master/experiments/text_generation_wikipedia_rnn/text_generation_wikipedia_rnn.ipynb">
          <b><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">维基百科文本生成（RNN）</font></font></b>
        </a>
      </td>
      <td>
...
<blockquote>
<p dir="auto"><g-emoji class="g-emoji" alias="warning"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">⚠️</font></font></g-emoji><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">将模型转换为 JS 可理解的格式并直接将其加载到浏览器可能不是一个好的做法，因为在这种情况下，用户可能需要将数十或数百兆字节的数据加载到浏览器，这是低效的。通常，模型由后端（即</font></font><a href="https://www.tensorflow.org/tfx" rel="nofollow"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">TensorFlow Extended</font></font></a><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">）提供，用户不会将其全部加载到浏览器，而是会执行轻量级 HTTP 请求来进行预测。但由于</font></font><a href="http://trekhleb.github.io/machine-learning-experiments/" rel="nofollow"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">演示应用程序</font></font></a><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">只是一个实验，而不是一个可用于生产的应用程序，为了简单起见（为了避免拥有一个正常运行的后端），我们将模型转换为 JS 可理解的格式并将它们直接加载到浏览器中。</font></font></p>
</blockquote>
...
<p dir="auto"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">推荐版本：</font></font></p>
<ul dir="auto">
<li><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Python：</font></font><code>&gt; 3.7.3</code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">。</font></font></li>
<li><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">节点：</font></font><code>&gt;= 12.4.0</code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">。</font></font></li>
<li><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">纱线：</font></font><code>&gt;= 1.13.0</code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">。</font></font></li>
</ul>
<p dir="auto"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">如果您有 Python 版本，</font></font><code>3.7.3</code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">您</font></font><code>RuntimeError: dictionary changed size during iteration</code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">在尝试时可能会遇到错误</font></font><code>import tensorflow</code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">（请参阅</font></font><a href="https://github.com/tensorflow/tensorflow/issues/33183" data-hovercard-type="issue" data-hovercard-url="/tensorflow/tensorflow/issues/33183/hovercard"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">问题</font></font></a><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">）。</font></font></p>
<div class="markdown-heading" dir="auto"><h2 tabindex="-1" class="heading-element" dir="auto"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">你也可能对此有兴趣</font></font></h2><a id="user-content-you-might-also-be-interested-in" class="anchor" aria-label="永久链接：您可能还感兴趣" href="#you-might-also-be-interested-in"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path d="m7.775 3.275 1.25-1.25a3.5 3.5 0 1 1 4.95 4.95l-2.5 2.5a3.5 3.5 0 0 1-4.95 0 .751.751 0 0 1 .018-1.042.751.751 0 0 1 1.042-.018 1.998 1.998 0 0 0 2.83 0l2.5-2.5a2.002 2.002 0 0 0-2.83-2.83l-1.25 1.25a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042Zm-4.69 9.64a1.998 1.998 0 0 0 2.83 0l1.25-1.25a.751.751 0 0 1 1.042.018.751.751 0 0 1 .018 1.042l-1.25 1.25a3.5 3.5 0 1 1-4.95-4.95l2.5-2.5a3.5 3.5 0 0 1 4.95 0 .751.751 0 0 1-.018 1.042.751.751 0 0 1-1.042.018 1.998 1.998 0 0 0-2.83 0l-2.5 2.5a1.998 1.998 0 0 0 0 2.83Z"></path></svg></a></div>
<ul dir="auto">
<li><a href="https://github.com/trekhleb/homemade-machine-learning/"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">自制机器学习</font></font></a><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">- 流行机器学习算法的 Python 示例，带有交互式 Jupyter 演示和数学解释。</font></font></li>
<li><a href="https://github.com/trekhleb/nano-neuron"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">NanoNeuron</font></font></a><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"> ——7 个简单的 JavaScript 函数，让您感受机器如何真正“学习”。</font></font></li>
<li><a href="https://github.com/trekhleb/learn-python"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">学习 Python 的游乐场和备忘单</font></font></a><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">- 按主题划分的 Python 脚本集合，包含带解释的代码示例。</font></font></li>
</ul>
<div class="markdown-heading" dir="auto"><h2 tabindex="-1" class="heading-element" dir="auto"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">文章</font></font></h2><a id="user-content-articles" class="anchor" aria-label="永久链接：文章" href="#articles"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path d="m7.775 3.275 1.25-1.25a3.5 3.5 0 1 1 4.95 4.95l-2.5 2.5a3.5 3.5 0 0 1-4.95 0 .751.751 0 0 1 .018-1.042.751.751 0 0 1 1.042-.018 1.998 1.998 0 0 0 2.83 0l2.5-2.5a2.002 2.002 0 0 0-2.83-2.83l-1.25 1.25a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042Zm-4.69 9.64a1.998 1.998 0 0 0 2.83 0l1.25-1.25a.751.751 0 0 1 1.042.018.751.751 0 0 1 .018 1.042l-1.25 1.25a3.5 3.5 0 1 1-4.95-4.95l2.5-2.5a3.5 3.5 0 0 1 4.95 0 .751.751 0 0 1-.018 1.042.751.751 0 0 1-1.042.018 1.998 1.998 0 0 0-2.83 0l-2.5 2.5a1.998 1.998 0 0 0 0 2.83Z"></path></svg></a></div>
<ul dir="auto">
<li><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">📝</font></font><a href="https://github.com/trekhleb/machine-learning-experiments/blob/master/assets/story.en.md"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">项目背后的故事</font></font></a></li>
<li><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">📝</font></font><a href="https://github.com/trekhleb/machine-learning-experiments/blob/master/assets/recipes_generation.en.md"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">使用 TensorFlow 和 LSTM 循环神经网络生成烹饪食谱</font></font></a><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">（分步指南）</font></font></li>
</ul>
...
<ul dir="auto">
<li><a href="https://trekhleb.dev" rel="nofollow"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">@trekhleb</font></font></a></li>
</ul>
</article></div>
